	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if(check!=null)
			{
				...
				boolean f2=daoImpl.checkUser(email);
				if(f2) {
					boolean f=daoImpl.userRegister(us);
					if (f) {
...
//			}
//			 else {
//					//System.out.println("please check terms");
//				 session.setAttribute("failedMsg","please check terms");
//				 resp.sendRedirect("register.jsp");
//				}

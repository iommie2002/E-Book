	...
	<div class="container">
		<div class="row p-5">
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<h5 class="text-primary"><i class="fas fa-paper-plane"></i>Email:<%=b.getEmail()%></h5>
				...
				<a href="index2.jsp" class="btn btn-success"><i class="fas fa-cart-plus"></i> Continue Shopping</a>
